namespace CopyFlyouts.Resources
{
    ...
    {
        public static readonly NamedAssetPath Damage = new ("Damage", "copy_flyouts.assets.audio.damage.wav");
        public static readonly NamedAssetPath Triangle = new ("Triangle", "copy_flyouts.Assets.Audio.triangle.wav"); // no idea why this has to be capitalized
        public static readonly NamedAssetPath Square = new ("Square", "copy_flyouts.Assets.Audio.square.wav");
